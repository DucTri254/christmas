...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi công chúa của anh :3";
    let charArrTitle = textTitle.split('');
let text = "Merry christmas my princess, năm nay là năm đầu tiên mình được đón noel cùng nhau tui là chỉ đón online nhưng anh rất vui vì có thể đón được noel với em. Anh cũng không biết nói gì hơn nữa chỉ là anh cảm ơn em vì đã đến bên anh. Anh yêu em nhiều lắm công chúa bé nhỏ <3"
